/**
 * Clase donde creamos el NPC oso, extiende de Entity 
 */
...
public class Npc extends Entity {
	...
	/**
	 * Constructor del NPC
	 * @param gl Recibe el game loop por parametros
	 */
	...
	/**
	 * Carga los sprites del oso para cada movimiento
	 */
...
//		rightIdle = new Image(getClass().getResourceAsStream("/assets/player/rightIdle.gif"));
	...
	/**
	 * Pinta la imagen del oso segun la direccion a la que se dirige
	 */
...
//	}
	 ...
	 * Tambien checkea colisiones en cada movimiento para saber si choca con un tile
	 */
